...
export const featuresData: IFeature[] = [
    {
        ...
        description: "Oue AI analyzes video content to suggest the most clickable concepts.",
    },
    {
    ...
    },
    {
        ...
        description: "Get fully layered designs you can tweak to perfection if needs.",
    },
];
  ...
  return (
    <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
      <SectionTitle
        ...
        text3="Create stuuning thumbnails that get clicks, without the hassle."
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
          ...
          >
            ...
            <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">
              boots your views with AI-optimized designs 
            </h3>
            <p className="text-slate-300 mt-2">
              Stop guessing and start ranking. Our AI creates designs proven to cepture attention.
            </p>
            <a
              href="/generate"
